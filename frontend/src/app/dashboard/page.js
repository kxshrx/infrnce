              ...
              <Card className="relative group cursor-pointer hover:shadow-lg transition-all border-l-4 border-l-primary">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Handles standard infrastructure logs with millisecond
                    response times using optimized regex patterns.
                  </p>
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Multi-tiered classification pipeline optimized for speed
                        and accuracy
                      </CardDescription>
                    </div>
                  </div>
                ...
                <CardContent>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Our intelligent routing system directs log messages through
                    a sophisticated multi-tiered classification pipeline. Simple
                    patterns are handled by lightning-fast regex engines, while
                    complex logs are escalated to BERT models and, when
                    necessary, to advanced LLM processing. This approach
                    optimizes both speed and accuracy while maintaining
                    exceptional cost efficiency across the entire classification
                    workflow.
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="regex" className="border-primary/10">
                      ...
                      <AccordionContent className="text-muted-foreground pt-4">
                        <p className="leading-relaxed mb-4">
                          ...
                          patterns with millisecond response times. Processes
                          common log formats including Apache, Nginx, syslog,
                          and application errors. Achieves 98.7% accuracy on
                          pattern-based classifications with zero computational
                          cost, making it the most efficient stage in our
                          pipeline.
                        </p>
                    ...
                    <AccordionItem value="bert" className="border-primary/10">
                      ...
                      <AccordionContent className="text-muted-foreground pt-4">
                        <p className="leading-relaxed mb-4">
                          Fine-tuned transformer model specializing in
                          contextual log understanding. Handles complex
                          application logs, stack traces, and multi-line error
                          messages that escape regex patterns. Balances accuracy
                          and performance with 50ms average processing time and
                    ...
                    <AccordionItem value="llm" className="border-primary/10">
                      ...
                      <AccordionContent className="text-muted-foreground pt-4">
                        <p className="leading-relaxed mb-4">
                          Advanced reasoning engine for highly complex, novel,
                          or ambiguous log entries. Leverages large language
                          models to understand context, technical terminology,
                          and nuanced error conditions. Reserved for the most
                          challenging cases, ensuring comprehensive coverage
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800 leading-relaxed">
                      The performance metrics and cost analyses presented above
                      are <strong>projected results</strong> based on
                      small-scale testing and theoretical modeling. These
                      figures have not been validated at enterprise scale and
                      should be considered as preliminary estimates. Actual
                      performance may vary significantly depending on log
                      complexity, volume, infrastructure configuration, and
