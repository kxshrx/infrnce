...
export default function Home() {
  ...
  const handleRandomLog = async () => {
    ...
    try {
      ...
      // Automatically switch to manual input tab
      setActiveTab("manual");
    } catch (err) {
    ...
    <div className="min-h-screen bg-transparent p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
          ...
          <CardContent className="p-6">
            ...
            >
              ...
              <TabsContent value="dataset" className="space-y-4">
                <div className="text-center p-8 border-2 border-dashed border-teal-200 rounded-lg bg-white/50">
        ...
        {error && (
          <Alert
            variant="destructive"
            className="bg-red-50/90 backdrop-blur-sm"
          >
        ...
        {classificationResult && (
          <div className="space-y-4">
            <Alert className="border-teal-200 bg-teal-50/90 backdrop-blur-sm">
